    ...
    companion object {
        val sampleData = listOf(
            Museum(
                ...
                funFactText = "El museo alberga una de las colecciones de arte de la Escuela Cusqueña más importantes del Perú."
            ),
            Museum(
                id = "2",
                ...
                funFactTitle = "La Dama de Ampato",
                funFactText = "La momia Juanita fue descubierta en 1995 en la cima del volcán Ampato a más de 6,200 metros sobre el nivel del mar."
            )
        )
    }
}